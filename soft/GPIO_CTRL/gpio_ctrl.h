...
#define LED_ALARM_CTR         GPIOD //火警灯GPIO
#define LED_ALARM_PIN         GPIO_Pin_6//火警灯控制引脚

#define LED_FAULT_CTR         GPIOD //故障灯GPIO
#define LED_FAULT_PIN         GPIO_Pin_3//故障灯控制引脚

#define LED_SELFTEST_CTR      GPIOD //自检灯控制GPIO
#define LED_SELFTEST_PIN      GPIO_Pin_2//自检灯控制引脚

#define LED_POWER_CTR         GPIOA //主电灯控制GPIO
#define LED_POWER_PIN         GPIO_Pin_9 //主电灯控制引脚

#define LED_BAT_CTR           GPIOB//备电灯控制GPIO
#define LED_BAT_PIN           GPIO_Pin_11 //备电灯控制引脚

#define RELAY_CTR             GPIOC //继电器控制GPIO
#define RELAY_PIN             GPIO_Pin_13//继电器控制引脚

#define AUDIO_SEL_CTR         GPIOC //语音输出控制GPIO
#define AUDIO_SEL_PIN         GPIO_Pin_1//语音输出控制引脚

#define AUDIO_CTR             GPIOC //功放芯片使能
#define AUDIO_CTR_PIN         GPIO_Pin_0 //功放芯片使能控制引脚

#define KEY_FIRE_CTR          GPIOB //火警键GPIO
#define KEY_FIRE_PIN          GPIO_Pin_0//火警键控制引脚

#define KEY_TEST_CTR          GPIOA //消音键GPIO
#define KEY_TEST_PIN          GPIO_Pin_7//消音键引脚

#define KEY_DOWN_CTR          GPIOC //下键GPIO
#define KEY_DOWN_PIN          GPIO_Pin_5//下键引脚

#define KEY_UP_CTR            GPIOA //上键GPIO
#define KEY_UP_PIN            GPIO_Pin_6//上键引脚

#define KEY_ACK_CTR           GPIOC //ACK键GPIO
#define KEY_ACK_PIN           GPIO_Pin_4

#define VBAT_ONOFF_CTR        GPIOB //电池打开和关闭控制
#define VBAT_ONOFF_PIN        GPIO_Pin_14

#define GPIO_IN_CTR           GPIOE //GPIO输入
#define GPIO_IN_PIN           GPIO_Pin_6


#define LED1_STA_CTR          GPIOC //LED1_STA GPIO
#define LED1_STA_PIN          GPIO_Pin_12

#define LED2_STA_CTR          GPIOA //LED2_STA GPIO
#define LED2_STA_PIN          GPIO_Pin_10
...
#define VBAT_KEY_CTR          GPIOB //充电芯片控制KEY
#define VBAT_KEY_PIN          GPIO_Pin_11

#define PWR_KEY_CTR           GPIOA //GPRS开关机按键
